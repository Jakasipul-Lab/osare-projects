...
export default function AboutView() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-5 py-24">
      ...
      {/* FOUNDER & CEO */}
      <div className="mt-20 rounded-3xl bg-blue-50 p-8 border border-blue-100 flex flex-col md:flex-row items-center gap-8">
        <div className="shrink-0">
          <img 
            src="/founder.jpg" 
            alt="Osare Nakinson - Founder & CEO" 
            className="w-32 h-32 md:w-40 md:h-40 rounded-2xl object-cover shadow-md border border-blue-200"
          />
        </div>
        <div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          {BRANCHES.map((b, i) => (
            <div key={i} className="border rounded-3xl p-6">
              ...
              <p className="mt-2 text-slate-800 font-medium">{b.person}</p>
              <p className="text-slate-600 text-sm">{b.role}</p>
              <p className="text-slate-500 text-sm mt-1">{b.email}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="mt-24">
        ...
        <div className="space-y-4 mt-8">
          {MILESTONES.map((m, i) => (
            <div key={i} className="border rounded-2xl p-4 text-slate-700 font-medium">{m}</div>
          ))}
        </div>
      </div>
      ...
      <div className="mt-24">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          {TESTIMONIALS.map((t, i) => (
            <div key={i} className="border rounded-3xl p-6 text-slate-600">&ldquo;{t}&rdquo;</div>
          ))}
        </div>
      </div>
      ...
      <div className="mt-24">
        ...
        <ul className="mt-6 space-y-4">
          {PRESS_RELEASES.map((p, i) => (
            <li key={i} className="border rounded-2xl p-4 text-slate-700">{p}</li>
          ))}
        </ul>
      </div>
      ...
      <div className="mt-24">
        ...
        <ul className="mt-6 space-y-4">
          {EVENTS.map((e, i) => (
            <li key={i} className="border rounded-2xl p-4 text-slate-700">{e}</li>
          ))}
        </ul>
      </div>

      {/* NEWSLETTER */}
      <div className="mt-24 border rounded-3xl p-8 bg-slate-50/50">
        <h2 className="text-3xl font-black">
      ...
      <div className="mt-24">
        ...
        <textarea
          ...
          className="mt-6 w-full border rounded-xl p-4 h-40 bg-white"
      ...
      <div className="mt-24">
        ...
        <div className="mt-8 space-y-4">
          {CAREERS.map((c, i) => (
            <div key={i} className="border rounded-2xl p-4 text-slate-700 font-medium">{c}</div>
          ))}
        </div>
      </div>
      ...
      <div className="mt-24">
        ...
        <ul className="mt-6 space-y-3">
          {FUTURE_GOALS.map((g, i) => (
            <li key={i} className="border rounded-2xl p-4 text-slate-700">{g}</li>
          ))}
        </ul>
      </div>
      ...
      <div className="mt-24 border rounded-3xl p-8 bg-slate-50/50">
        ...
        <div className="grid gap-4 mt-6">
          ...
          <textarea
            ...
            className="border rounded-xl p-4 h-40 bg-white"
            placeholder="Message"
          />
        </div>
        <button
